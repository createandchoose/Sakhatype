    ...
    <Alert class="flex items-center gap-2 p-1 px-3">
      <ToggleGroup type="single" v-model="currentType" class="flex gap-1">
        <ToggleGroupItem
          ...
          class="px-3 rounded-lg text-sm font-medium transition-all dark:data-[state=on]:bg-[#2a2a2a] dark:data-[state=on]:text-white data-[state=on]:bg-gray-200 data-[state=on]:text-gray-900 text-gray-500 hover:bg-gray-100 dark:hover:bg-[#1a1a1a]"
        >
          Время
        </ToggleGroupItem>
      </ToggleGroup>
